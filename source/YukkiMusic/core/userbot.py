...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("E_16_E")
                await self.one.join_chat("E_16_E")
                await self.one.join_chat("E_16_E")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("E_16_E")
                await self.two.join_chat("E_16_E")
                await self.two.join_chat("E_16_E")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("E_16_E")
                await self.three.join_chat("E_16_E")
                await self.three.join_chat("E_16_E")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("E_16_E")
                await self.four.join_chat("E_16_E")
                await self.four.join_chat("E_16_E")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("E_16_E")
                await self.five.join_chat("E_16_E")
                await self.five.join_chat("E_16_E")
            except:
                pass
