...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/E_16_E) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/E_16_E) /Rico \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/E_16_E)\n [Rico 𝖳𝖾𝖺𝖬](https://t.me/Y_H_U_4)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/E_16_E) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/E_16_E"),
...
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="afyona"),
                ...
                [
                    InlineKeyboardButton(
                        "الكروب", url=f"https://t.me/E_16_E"
                    ),
                    InlineKeyboardButton(
                        "القناة", url=f"https://t.me/E_16_E"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "Rico 𝖳𝖾𝖺𝖬", url="https://t.me/E_M_1"
                    )
                ],
            ]
        ),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/E_16_E) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/Y_H_U_4) \n ※[These Features AI Based](https://t.me/E_16_E)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="E_M_1"),
                ],
                [                
                ...
                [
                    InlineKeyboardButton(
                        "Group", url=f"https://t.me/E_16_E"
                    ),
                    InlineKeyboardButton(
                        "Channel", url=f"https://t.me/E_16_E"
                    ),
                ],
                [
                    InlineKeyboardButton(
...
@Client.on_callback_query(filters.regex("E_M_1"))
async def cbguides(_, query: CallbackQuery):
    await query.answer("user guide")
    await query.edit_message_text(
        f""" **※Welcome \n
※Show members keyboard Send /ARN \n\n
※Show entertainment keyboard send /Rico**
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 Go Back", callback_data="english")]]
        ),
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع افيونا من هن : @E_M_1 **
\n __ Developer by [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_M_1)""",
        reply_markup=InlineKeyboardMarkup(
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""※ مرحبا بك \n ※ لتفعيل كيبورد الاعضاء ارسل /ARN \n ※ لتفعيل كيبورد التسليه ارسل /Rico""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("العودة", callback_data="bcmds")]]
        ),
    )
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b> يمكنك التواصل معي \n عن طريق معرفي اول كروب التواصل بلاسفل..↑↓ \n\n [Rico 𝖳𝖾𝖺𝖬](https://t.me/E_M_1)</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("القناة", url=f"https://t.me/E_16_E"),
                    InlineKeyboardButton("الكروب", url=f"https://t.me/E_16_E"),
                ],
                [
                    InlineKeyboardButton("البوت", url=f"https://t.me/Ophbot"),
                    InlineKeyboardButton("التواصل", url=f"https://t.me/Taw"),
                ],
                [InlineKeyboardButton("ᖴ᥆ᖇ. 🐉", url=f"https://t.me/E_M_1")],
            ]
        ),
    )
