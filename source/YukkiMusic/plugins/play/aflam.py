"""
        ...
        [InlineKeyboardButton("Rico 𝖳𝖾𝖺𝖬", url=f"https://t.me/E_16_E")],
"""
...
async def aflamAR(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("افلام 🎬", callback_data="fil " + str(m.from_user.id))],
        [InlineKeyboardButton("مسلسلات 📼", callback_data="mossl " + str(m.from_user.id))],
        [InlineKeyboardButton("مسرحيات 🎭 ", callback_data="msrhia " + str(m.from_user.id))],
