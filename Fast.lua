...
return send(data.chat_id,data.id,"※ الوضع المجاني معطل من قبل مطور الصانع @E_M_1")
end
if text == "※ الغاء" then
Redis:del(Fast..data.sender_id.user_id.."bottoken")
Redis:del(Fast..data.sender_id.user_id.."dev:user")
...
send(data.chat_id,data.id,"※ اهلا بك في صانع بوتات ميوزك سورس ريكو \n※ قناه السورس البوت @E_16_E \n مبرمج السورس: @E_M_1 ","html",true, false, false, true, reply_markup)
return false 
end
---making user
